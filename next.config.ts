...
const nextConfig: NextConfig = {
  async redirects() {
    return [
      ...
      ...["5-signs-you-need-a-licensed-demolition-contractor", "a-comprehensive-guide-to-residential-demolition-services", "blog", "brooksville", "choosing-the-right-demolition-contractor", "commercial-demolition", "concrete-foundation-removal", "contact", "crystal-river-debris-removal-after-demolition", "debris-removal-hauling", "demolition-excavation-services-citrus-county-fl", "demolition-permits-citrus-county-fl", "emergency-demolition-crystal-river", "emergency-demolition", "hernando-residential-demolition", "hernando", "house-demolition-cost", "how-long-does-it-take-to-demolish-a-house-in-crystal-river-fl", "inverness-commercial-demolition", "inverness-demolition", "inverness-land-clearing", "inverness-residential-demolition", "inverness-site-preparation", "inverness", "land-clearing", "licensed-residential-demolition-contractor-crystal-river-fl", "mobile-home-demolition", "mobile-home-demolition-contractor-license-insurance-crystal-river-fl", "mobile-home-demolition-services-citrus-county", "mobile-home-demolition-vs-removal-central-florida", "pool-removal", "projects", "residential-contractor-florida", "residential-demolition", "selective-demolition", "site-preparation-services-crystal-river-fl", "site-preparation", "spring-hill-land-clearing", "spring-hill", "understanding-hidden-costs-residential-demolition", "who-removes-old-mobile-homes-crystal-river-fl", "why-citrus"].map((slug) => ({ source: `/${slug}.html`, destination: `/${slug}`, permanent: true })),
    ];
  },
  async rewrites() {
    return {
